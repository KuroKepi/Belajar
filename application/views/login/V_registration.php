        ...
        <div class="row">
          <div class="col-lg">
            <div class="p-5">
			  ...
			  <form class="user" action="<?php echo base_url().'C_login/registration' ?>" method="POST">
			  <div class="form-group">
				  <input type="hidden" class="form-control form-control-user" id="id" name="id" value="<?php echo $kode ?>">
                </div>
                <div class="form-group">
