...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
	<!-- DataTables -->
  <link rel="stylesheet" href="<?php echo base_url('assets/dashboard/')?>plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="<?php echo base_url('assets/dashboard/')?>plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
	<!-- jQuery -->
	<script src="<?php echo base_url('assets/dashboard/')?>plugins/jquery/jquery.min.js"></script>
	<!-- SweetAlert -->
	<script src="<?php echo base_url('assets/dashboard/')?>plugins/sweetalert2/sweetalert2.all.min.js"></script>
</head>
